...
// Fetch songs from a folder and display them in the list
...
                    <div class="info"><div> ${song.replaceAll("%20", " ")}</div><div>songartist</div></div>
...
                    xmlns="http://www.w3.org/2000/svg"><path d="M5 20V4L19 12L5 20Z" stroke="#141B34" fill="#000" stroke-width="1.5"
